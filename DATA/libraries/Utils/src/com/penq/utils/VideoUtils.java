...
public class VideoUtils {
	...
	public String multipartRequest(String urlTo, String post, String filepath, String filefield, Activity a) throws ParseException, IOException {
		...
		/*	String[] q = filepath.split("/");
			...
			try {
				...
				InputStream fileInputStream =a.getAssets().open("ic_launcher.png");
				...
				outputStream.writeBytes("Content-Disposition: form-data; name=\"" + filefield + "\"; filename=\"" + "nevig.mp4"/*q[idx]*/ +"\"" + lineEnd);
